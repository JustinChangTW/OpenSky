...
const UI_STRINGS = {
  en: {
    ...
    "workspace.proxyResourceMode": "OpenSky is proxying this page through the backend. Same-domain styles, images, and fonts are loaded first.",
  ...
  zh: {
    ...
    "workspace.relayLoading": "正在載入代理文件...",
    "workspace.proxyPhase1Label": "受控代理檢視",
    "workspace.proxyResourceMode": "OpenSky 會先透過後端代理這個頁面。同網域的樣式、圖片與字型會優先載入。",
